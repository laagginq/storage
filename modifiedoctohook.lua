--[[
    ...
    Modified by tatar0071#0627 and xz#1111
...
function crypt(data)
    local greennigga = (syn and syn.crypt.base64.decode) or (fluxus and fluxus.crypt.base64.decode) or base64.decode
    if greennigga then 
        return greennigga(data)
    else
        game.Player.LocalPlayer:Kick(executor.." is not supported")
    end
end
