...
function library.new(library_title, cfg_location)
    ...
    function menu.save_cfg(cfg_name)
        ...
        writefile(cfg_location.."/settings"..cfg_name..".cfg", crypt.base64encode(http:JSONEncode(values_copy)))
    end
    function menu.load_cfg(cfg_name)
        local new_values = http:JSONDecode(crypt.base64decode(readfile(cfg_location.."/settings"..cfg_name..".cfg")))
    ...
    local ImageLabel = library:create("ImageButton", {
        ...
        BorderColor3 = Color3.fromRGB(111, 50, 168),
        Position = UDim2.new(0.5, 0, 0.5, 0),
        Size = UDim2.new(0, 700, 0, 500),
        Image = "http://www.roblox.com/asset/?id=16501095687",
    ...
    function menu.new_tab(tab_image)
        ...
        if is_first_tab then
            ...
            TabImage.ImageColor3 = Color3.fromRGB(111, 50, 168)
            Tab.Visible = true
        end
        ...
        TabButton.MouseButton1Down:Connect(function()
            ...
            Tab.Visible = true
            selected_tab = TabButton
            library:tween(TabImage, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(111, 50, 168)})
        end)
        ...
        function tab.new_section(section_name)
            ...
            local UIGradient = library:create("UIGradient", {
                Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(32, 33, 38)), ColorSequenceKeypoint.new(0.5, Color3.fromRGB(111, 50, 168)), ColorSequenceKeypoint.new(1, Color3.fromRGB(32, 33, 38))},
            }, SectionDecoration)
            ...
            SectionButton.MouseButton1Down:Connect(function()
                ...
                library:tween(SectionButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(111, 50, 168)})
            ...
            if is_first_section then
                ...
                SectionButton.TextColor3 = Color3.fromRGB(111, 50, 168) 
            ...
            function section.new_sector(sector_name, sector_side)
                ...
                function sector.element(type, text, data, callback, c_flag)
                    ...
                    if type == "Toggle" then
                        ...
                        function element:set_value(new_value, cb)
                            ...
                            if value.Toggle then
                                library:tween(ToggleFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(111, 50, 168)})
                        ...
                        function element:add_keybind(key_default, key_callback)
                            ...
                            KeybindFrame.MouseEnter:Connect(function()
                                keybind_in2 = true
                                library:tween(KeybindFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(111, 50, 168)})
                            end)
                            ...
                            for _,TypeButton in next, KeybindFrame:GetChildren() do
                                ...
                                TypeButton.MouseButton1Down:Connect(function()
                                    ...
                                    library:tween(TypeButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(111, 50, 168)})
                                end)
                            end
                            ...
                            function keybind:set_value(new_value, cb)
                                ...
                                for _,TypeButton2 in next, KeybindFrame:GetChildren() do
                                    ...
                                    if TypeButton2.Name ~= extra_value.Type then
                                        ...
                                        library:tween(TypeButton2, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(111, 50, 168)})
                                    end
                                end
                        ...
                        function element:add_color(color_default, has_transparency, color_callback)
                            ...
                            ColorFrame.MouseEnter:Connect(function()
                                in_color = true
                                library:tween(ColorFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(111, 50, 168)})
                            end)
                    ...
                    elseif type == "Dropdown" then
                        ...
                        for _,v in next, data.options do
                            ...
                            local Decoration = library:create("Frame", {
                                Name = "Decoration",
                                BackgroundColor3 = Color3.fromRGB(111, 50, 168),
                                BorderSizePixel = 0,
                                Size = UDim2.new(0, 1, 1, 0),
                                Visible = false,
                                ZIndex = 2,
                    ...
                    elseif type == "Button" then
                        ...
                        Button.MouseButton1Down:Connect(function()
                            Button.BorderColor3 = Color3.fromRGB(111, 50, 168)
                    ...
                    elseif type == "TextBox" then
                        ...
                        uis.TextBoxFocused:connect(function()
                            if uis:GetFocusedTextBox() == TextBox then
                                library:tween(TextBox, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(111, 50, 168)})
                            end
                        end)
                    ...
                    elseif type == "Scroll" then
                        ...
                        local ScrollFrame = library:create("ScrollingFrame", {
                            ...
                            TopImage = "rbxasset://textures/ui/Scroll/scroll-middle.png",
                            AnchorPoint = Vector2.new(0.5, 0),
                            ScrollBarImageColor3 = Color3.fromRGB(111, 50, 168),
                        }, Scroll)
                    ...
                    elseif type == "Slider" then
                        ...
                        local UIGradient = library:create("UIGradient", {
                            Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(111, 50, 168)), ColorSequenceKeypoint.new(1, Color3.fromRGB(111, 50, 168))},
                            Rotation = 90,
                        }, SliderFrame)
